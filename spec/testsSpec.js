...
describe("Kaprekar Routine function", function() {
	...
	describe("Recursive Cases", function() {
		...
		describe("Recursive Case n=111, length 3 and almost a repdigit", function() {
		    ...
		    it("should return ? iterations", function() {
		    	expect(kaprekar_routine(111)).toEqual(3);
		    });
		});
		describe("Recursive Case n=1112, length 4", function() {
			//what should it return
		    it("should return ? iterations", function() {
		    	expect(kaprekar_routine(1112)).toEqual(3);
		    });
		});
		describe("Recursive Case n=1, length 1, minimum legal value", function() {
			//what should it return
		    it("should return ? iterations", function() {
		    	expect(kaprekar_routine(1)).toEqual(3);
		    });
		});
	...
	describe("Invalid input to function", function() {
		it("should return instructional message about valid input if input is a negative number", function() {
			expect(kaprekar_routine(-1)).toEqual("Input must be a positive integer of 4 or less digits in length");
		});
		it("should return instructional message about valid input if input is a number that is 5 digits long", function() {
			expect(kaprekar_routine(49857)).toEqual("Input must be a positive integer of 4 or less digits in length");
		});
		it("should return instructional message about valid input if input is a number that is 5 digits long with a leading 0", function() {
		...
		it("should return instructional message about valid input if input is a number much longer than 4 digits", function() {
			expect(kaprekar_routine(758473626254643828473)).toEqual("Input must be a positive integer of 4 or less digits in length");
		});
		it("should return instructional message about valid input if input is a decimal", function() {
			expect(kaprekar_routine(48.8)).toEqual("Input must be a positive integer of 4 or less digits in length");
		});
		it("should return instructional message about valid input if input is a string", function() {
			expect(kaprekar_routine("hello world")).toEqual("Input must be a positive integer of 4 or less digits in length");
		});
		it("should return instructional message about valid input if input is 0", function() {
